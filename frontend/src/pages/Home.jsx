            ...
            <div className="flex justify-center space-x-4 mb-20">
                <div className="flex border border-gray-300 rounded-lg overflow-hidden shadow-sm max-w-2xl w-full">
                    <input 
                        ...
                        className="p-4 w-1/3 border-r border-gray-300 outline-none" 
                    />
                    <input 
                        type="text" 
                        placeholder="What services you are looking for?" 
                        className="p-4 w-2/3 outline-none" 
                    />
                    <button className="bg-black text-white px-8 py-4 font-medium">Search</button>
                </div>
            </div>
